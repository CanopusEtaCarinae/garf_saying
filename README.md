...
前面有分类索引，之后的目录分两级，第一级目录-1为按顺序的大致出处（需点击展开目录-2使用。另外正文每个 **“返回目录对应处”** 链接都要展开目录-2来使用），即出自Web哪一大章和文库哪卷；第二级目录-2就是谚语本身的目录列表。
...
[Web四章（圣域篇）](#1突き抜ける杭ほど先細って脆いWEB-1-WEB第四章) &nbsp; [Web五章（水门都市篇）](#79値札も付けなくていいしweb-48文4645-WEB第五章) &nbsp; [暴食IF](#103オズムンドの躊躇いweb-58-暴食IF) &nbsp; [WEB七章（帝国篇）](#140孤立無援のデクー高地web-60-WEB第七章)
...
[动画二期SP](#138生き急ぐナナホシは葉っぱを畳む-动画SP)
...
[短篇集6（女神像+卷尾预告）](#134コドロがオオドロと早合点文9588-短篇女神像) &ensp; [Zeropedia](#137バリンクロンの絆は歯が見える笑いの中文9891-Zeropedia)
...
#### [134、『コドロがオオドロと早合点』[文(95/88)]-【短篇：女神像】](#短篇集-6三马鹿女神像篇)
...
#### [140、『孤立無援のデクー高地』(web-60)-【WEB第七章】](#140WEB七-6web-60)
</details>
...
不过这附近的翻译好像值得说道一下，这里台版和简中的翻译区别还插明显……谚语本身的话，台版就是简单的这个大精灵隐居山林，简中反而把这个名说成地名了……另外加菲猫的用词语气也有差，台版像是用谚语埋怨西玛似的。后来请教了[@菲泡露](https://tieba.baidu.com/home/main?un=%E8%8F%B2%E6%B3%A1%E9%9C%B2&ie=utf-8&id=tb.1.b3d5d10b.QGvdDl90mhStK-8zEaXW9g?t=1603640692&fr=pb)大佬，基本认为应该是加菲猫语气是简中准，谚语的翻译是台版准。结合老贼推上的资料确实还是这样比较顺了
...
[返回索引/目录](#索引)
[返回目录对应处](#61クウェインの石は一人じゃ上がらないweb-38文32动11)
...
[返回索引/目录](#索引)
[返回目录对应处](#63今一歩のギルティラウ文33动12TV31预告5)
...
[返回索引/目录](#索引)
[返回目录对应处](#65恋はリングドーンの先人に倣え文35动13-14卷)
...
[返回索引/目录](#索引)
[返回目录对应处](#68ラインハルトからは逃げられない文38动15)
...
[返回索引/目录](#索引)
[返回目录对应处](#69攻撃は最大の防御web-40文39动16)
...
[返回索引/目录](#索引)
[返回目录对应处](#73剣聖レイドは龍を前に剣を抜いて笑うweb-44文42动17-15卷)
...
番外的肉馅饼情节。这里谚语翻译有经[@菲泡露](https://tieba.baidu.com/home/main?un=%E8%8F%B2%E6%B3%A1%E9%9C%B2&ie=utf-8&id=tb.1.b3d5d10b.QGvdDl90mhStK-8zEaXW9g?t=1603640692&fr=pb)大佬校对过，比网上流传的资源有所修改。虽然这样译出来很容易理解谚语的寓意大概是行事要耐心或好事多磨之类，不过在这篇里倒好像是在说做肉馅饼本身了……另外就是这年轻蛋糕，翻译译似乎吐槽了下德语词，不过据说这个年轮蛋糕本身在日本就常见，因此要从这里说486又懂德语大概就是有些敏感了😷
...
Web和文库此处情节一样，就是谚语被完全换掉了。要分别放语境里理解的话，Web是说对没瞧上眼的小鬼没兴趣……？文库这里是[@菲泡露](https://tieba.baidu.com/home/main?un=%E8%8F%B2%E6%B3%A1%E9%9C%B2&ie=utf-8&id=tb.1.b3d5d10b.QGvdDl90mhStK-8zEaXW9g?t=1603640692&fr=pb)大佬的翻译和台版有出入了，按大佬的看法应该是说过冬后翻译准确，毕竟过了冬后面好像就有些是成长或者蜕变之类的意思，用以表达八腕对加菲猫态度的转变
...
[返回索引/目录](#索引)
[返回目录对应处](#113114時間とお金は等価値文74717571115時間は金銭に等しいweb-59時間とお金は価値は一緒文7671动0-短篇正篇三章)
...
[返回索引/目录](#索引)
[返回目录对应处](#119ホーシンは口約束を死んでも守った文8074-5卷蜜瓜-掌篇集2)
...
[返回索引/目录](#索引)
[返回目录对应处](#131オロロンの悪癖文9286-22卷gamers)
...
[返回索引/目录](#索引)
[返回目录对应处](#132剣聖レイドは龍を前に剣を抜いて笑う文9386)
...
[返回索引/目录](#索引)
[返回目录对应处](#133モーテッソの山喰らい文9487-23卷gamers)
...
[返回索引/目录](#索引)
[返回目录对应处](#134コドロがオオドロと早合点文9588-短篇女神像)
...
[返回索引/目录](#索引)
[返回目录对应处](#135バラモンの川下り文9689-短篇集6卷尾)
...
奥托在女装身份和实际身份上纠结细节被加菲猫吐槽。单看谚语本身似乎就是再这样下去会很惨，不过谚语里这个惨本身是不是想表达是由硬纠细节所导致的意思，还是说就是像平时那样吐槽奥托太操心？大概还需要阅读大佬们再指点指点……😷

[返回索引/目录](#索引)
[返回目录对应处](#136モルタウ平原のやけっぱち文9790)
...
[返回索引/目录](#索引)
[返回目录对应处](#137バリンクロンの絆は歯が見える笑いの中文9891-Zeropedia)
...
[返回索引/目录](#索引)
[返回目录对应处](#138生き急ぐナナホシは葉っぱを畳む-动画SP)
...
[返回索引/目录](#索引)
[返回目录对应处](#139ホーシンの御旗で拭けば銀貨はビカペツカ)
...
[返回索引/目录](#索引)
[返回目录对应处](#140孤立無援のデクー高地web-60-WEB第七章)
